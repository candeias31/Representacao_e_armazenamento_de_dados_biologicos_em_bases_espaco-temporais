for(i=0;i<150;i++){
    ...
    setOption("BlackBackground", true);
        ...
        saveAs("Tiff", "C:/Users/cool_/Documents/Representacao_e_armazenamento_de_dados_biologicos_em_bases_espaco-temporais/Datasets/TrackingChallenge/Fluo-N2DH-SIM+/02_GT/TRA/segmented//Huang0/"+fileTif);
    close();
    }
